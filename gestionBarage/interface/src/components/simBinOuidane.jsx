...
class SimBinOuidane extends React.Component{
    ...
    onCalcul(e){
        ...
        this.setState({
            ...
            let esResult99 = parseFloat(this.state.reserve) + parseFloat(this.state.app99) - parseFloat(this.state.evap) - this.state.irrReste - this.state.aepiReste - this.state.debitSanitaire - this.state.transfert
            let esResult98 = parseFloat(this.state.reserve) + parseFloat(this.state.app98) - parseFloat(this.state.evap) - this.state.irrReste - this.state.aepiReste - this.state.debitSanitaire - this.state.transfert
            let esResult95 = parseFloat(this.state.reserve) + parseFloat(this.state.app95) - parseFloat(this.state.evap) - this.state.irrReste - this.state.aepiReste - this.state.debitSanitaire - this.state.transfert
            let esResult90 = parseFloat(this.state.reserve) + parseFloat(this.state.app90) - parseFloat(this.state.evap) - this.state.irrReste - this.state.aepiReste - this.state.debitSanitaire - this.state.transfert
            let taux99 = (esResult99 / 1215.504) * 100
            let taux98 = (esResult98 / 1215.504) * 100
            let taux95 = (esResult95 / 1215.504) * 100
            let taux90 = (esResult90 / 1215.504) * 100
    ...
    render(){
        return(
            ...
            <div className="title">
                <h4>Résultats de simulation de la gestion des retenues du barrage Bin Ouidane</h4>
                ...
                <table className="table">
                    <thead>
                        <tr>
                            ...
                            <th>AEPI</th>
                            <th rowSpan="3">Débit sanitaire</th>
                            <th rowSpan="3">Transfert</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td rowSpan="4"><input className="numbers" onBlur={this.onCalcul} name="debitSanitaire" type="number" defaultValue={this.state.debitSanitaire} /></td>
                            <td rowSpan="4"><input className="numbers" onBlur={this.onCalcul} name="transfert" type="number" defaultValue={this.state.transfert} /></td>
            ...
            <table className="table" id="table-to-xls" style={{display:"none"}}>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td rowSpan="4">{this.state.debitSanitaire}</td>
                            <td rowSpan="4">{this.state.transfert}</td>
